    ...
    <section className="py-20 bg-gradient-to-br from-rose-50 via-background to-sky-50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {/* Before Card */}
          <div className="bg-gradient-to-br from-rose-100 to-rose-50 rounded-2xl p-6 border border-rose-200">
          ...
          {/* After Card */}
          <div className="bg-gradient-to-br from-emerald-100 to-sky-50 rounded-2xl p-6 border border-emerald-200 relative">
            <div className="absolute -top-3 -right-3 bg-success text-success-foreground text-xs font-bold px-3 py-1.5 rounded-full">
              সফটেক
            </div>
            ...
            <div className="space-y-3">
              {afterItems.map((item, index) => (
                ...
                >
                  ...
                  <span className="text-card-foreground">{item.text}</span>
                  <div className="ml-auto h-6 w-6 rounded-full bg-success flex items-center justify-center">
